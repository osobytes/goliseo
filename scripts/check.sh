...
#      final_hash=51d1e26eb1dc66dc and sequence_digest=831e70be42afdbc1.
...
#      gc_data::tunables), then both again by the 2026-08-26 #622 follow-up
#      (owner-approved: the keeper's race-to-ball interception,
#      gc_sim::keeper::intercept_race, plus the keeper_engagement band's
#      x1.7167 rescale to the futsal box geometry) --
...
EXPECTED_FINAL_HASH="51d1e26eb1dc66dc"
EXPECTED_SEQUENCE_DIGEST="831e70be42afdbc1"
EXPECTED_TICKS="7201"
