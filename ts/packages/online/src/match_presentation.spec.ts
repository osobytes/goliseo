...
// moved it to 15, same reasoning as `PHASE_STEPS`'s note just below: a
...
// still zero). 15 is the smallest period tried that deterministically
// restores at least one revocation, confirmed across repeated runs, and
// every other phase in this describe block still passes at 15 -- it stays
// comfortably inside the same ~30-tick window the original comment names.
//
