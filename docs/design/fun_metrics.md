...
- **2026-08-28 — the first-touch release gains block grace (#623 follow-up,
  play-test telemetry).** `baseline_version` **24 → 25**, signature
  `a3cf270de2e68c50` → `185f5641f5682c5e`. The first instrumented play-test
  ...
  Re-frozen with the `keeper_shadow_classifier` re-pin (candidates 16864)
  and the `session_ai_driven` / `ai_driven_evidence` re-records (final
  `f52ad4eeb1c6d661`, sequence `0dfef5c0efe59c8b`) in the same commit.
