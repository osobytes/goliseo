...
pub const RECORD: OutfieldAiBaselineRecord = OutfieldAiBaselineRecord {
    ...
    stats: OutfieldAiBaselineStats {
        fun: OutfieldAiBaselineStat {
            n: 60,
            mean: 0.2654423576368298,
            sd: 0.3551743268061643,
            min: 0.0,
        ...
        shots: OutfieldAiBaselineStat {
            n: 60,
            mean: 25.633333333333333,
            sd: 7.2204198823085175,
            min: 7.0,
            max: 39.0,
        },
        shots_per_goal: OutfieldAiBaselineStat {
            n: 57,
            mean: 12.626315789473683,
            sd: 9.189338277042847,
            min: 2.3333333333333335,
            max: 38.0,
        },
        save_rate: OutfieldAiBaselineStat {
            n: 60,
            mean: 0.7860092158188302,
            sd: 0.15540901120730177,
            min: 0.25,
            max: 1.0,
        },
        ...
        ai_jukes: OutfieldAiBaselineStat {
            n: 60,
            mean: 15.95,
            sd: 5.247840556693255,
            min: 2.0,
            max: 28.0,
        },
    },
    signature: "e78eba38e07c1356",
};
