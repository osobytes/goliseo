...
pub const RECORD: OutfieldAiBaselineRecord = OutfieldAiBaselineRecord {
    ...
    stats: OutfieldAiBaselineStats {
        fun: OutfieldAiBaselineStat {
            n: 60,
            mean: 0.2863023092578512,
            sd: 0.36101288414048943,
            min: 0.0,
            max: 0.9065238385443695,
        },
        goals_total: OutfieldAiBaselineStat {
            n: 60,
            mean: 2.933333333333333,
            sd: 1.1625026577941795,
            min: 0.0,
            max: 5.0,
        },
        ...
        shots: OutfieldAiBaselineStat {
            ...
            sd: 7.250170463610661,
            min: 11.0,
            max: 43.0,
        },
        shots_per_goal: OutfieldAiBaselineStat {
            n: 59,
            mean: 12.312146892655365,
            sd: 8.977601347950625,
            min: 2.75,
            max: 38.0,
        },
        save_rate: OutfieldAiBaselineStat {
            n: 60,
            mean: 0.7172552706008586,
            sd: 0.15408989739211187,
            min: 0.2,
            max: 1.0,
        },
