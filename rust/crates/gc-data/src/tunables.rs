...
pub static SIM_TUNABLES: &[TunableDef] = &[
    ...
    TunableDef {
        ...
        max: 1.4,
        step: 0.02,
        desc: "Top-speed multiplier over base move speed while in the carry context.",
    },
    TunableDef {
        ...
        max: 2.0,
        step: 0.05,
        desc: "Acceleration multiplier over the shared base while in the carry context.",
    },
    TunableDef {
        ...
        max: 2.5,
        step: 0.05,
        desc: "Deceleration multiplier over the shared base while in the carry context.",
    },
    TunableDef {
        ...
        max: 2.5,
        step: 0.05,
        desc: "Angular-rate multiplier over the shared base while in the carry context.",
    },
    TunableDef {
        ...
        max: 1.4,
        step: 0.02,
        desc: "Top-speed multiplier over base move speed while in the sprint carry context.",
    },
    TunableDef {
        ...
        max: 2.0,
        step: 0.05,
        desc: "Acceleration multiplier over the shared base while in the sprint carry context.",
    },
    TunableDef {
        ...
        max: 2.5,
        step: 0.05,
        desc: "Deceleration multiplier over the shared base while in the sprint carry context.",
    },
    TunableDef {
        ...
        max: 2.5,
        step: 0.05,
        desc: "Angular-rate multiplier over the shared base while in the sprint carry context.",
    },
    TunableDef {
    ...
    TunableDef {
        ...
        max: 179.0,
        step: 5.0,
        desc: "Heading change beyond which a body brakes through zero instead of arcing.",
    },
    TunableDef {
        id: "LOCO_STRAFE_ARC_DEG",
        tier: Tier::Sim,
        label: "Strafe arc",
        cat: "Locomotion",
        default: 55.0,
        ...
        max: 89.0,
        step: 5.0,
        desc: "Movement-versus-facing angle beyond which the context is a strafe.",
    },
    TunableDef {
        id: "LOCO_BACKPEDAL_ARC_DEG",
        tier: Tier::Sim,
        label: "Backpedal arc",
        cat: "Locomotion",
        default: 120.0,
        ...
        max: 179.0,
        step: 5.0,
        desc: "Movement-versus-facing angle beyond which the context is a backpedal.",
    },
    TunableDef {
